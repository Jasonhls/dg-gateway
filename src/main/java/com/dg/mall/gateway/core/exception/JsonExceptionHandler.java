package com.dg.mall.gateway.core.exception;
...
public class JsonExceptionHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        if (ex instanceof NotFoundException) {
            ...
            httpStatus = ((ServiceException) ex).getCode();
            body = ((ServiceException) ex).getErrorMessage();
        }else {
        ...
        LogUtil.error("[全局异常处理]异常请求路径:".concat(request.getPath().toString()).concat(",记录异常信息:")
